...
const AcceptMessage: React.FC = () => {
  ...
  const [isAcceptingMessage, setIsAcceptingMessage] = useState<boolean>(user?.isAcceptingMessages ?? false);
  ...
  return (
    <div className="flex items-center space-x-2">
      <Switch id="accepting-message" checked={isAcceptingMessage} onCheckedChange={handleToggle} />
